...
(
    invoice_id INTEGER DEFAULT nextval('invoice_sequence') NOT NULL,
    order_id INTEGER NOT NULL,
    invoice_date TIMESTAMP CONSTRAINT invoice_def DEFAULT current_timestamp,
    toPay NUMERIC(6,2) NOT NULL,
